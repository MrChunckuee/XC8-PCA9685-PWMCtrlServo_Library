# 1 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c" 2
# 40 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c"
# 1 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.h" 1
# 34 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.h"
...
# 34 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.h" 2
# 81 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.h"
...
# 40 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c" 2

# 1 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.h" 1
# 57 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.h"
void I2C_Init(void);
void I2C_Start(void);
...
# 41 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c" 2




float _oscillator_freq;
# 55 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c"
void PCA9685_Init(void){
     I2C_Start();
     I2C_Write_Byte(0x80);
     I2C_Write_Byte(0x00);
     I2C_Write_Byte(0b00110001);
     I2C_Stop();
     ...
     I2C_Write_Byte(0x80);
     I2C_Write_Byte(0x01);
     I2C_Write_Byte(0b00000100);
     I2C_Stop();
}
# 94 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c"
void PCA9685_SetPWM(unsigned char CHANNEL, unsigned int DATA_ON, unsigned int DATA_OFF){
    I2C_Start();
    I2C_Write_Byte(0x80);
    I2C_Write_Byte(0x06 + 4 * CHANNEL);
...
# 116 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c"
void PCA9685_WriteByte(unsigned char ADDR, unsigned char DATA){
     I2C_Start();
     I2C_Write_Byte(0x80);
     I2C_Write_Byte(ADDR);
...
# 133 "../XC8-18F25K22_ServoCtrl_Module.X/PCA9685.c"
unsigned char PCA9685_ReadByte(unsigned char ADDR){
...
void PCA9685_SetPWMFreq(float freq) {
  ...
  unsigned char oldmode = PCA9685_ReadByte(0x00);
  unsigned char newmode = (oldmode & ~0x80) | 0x10;
  PCA9685_WriteByte(0x00, newmode);
  PCA9685_WriteByte(0xFE, prescale);
  PCA9685_WriteByte(0x00, oldmode);
  _delay((unsigned long)((5)*(64000000/4000.0)));

  PCA9685_WriteByte(0x00, oldmode | 0x80 | 0x20);
