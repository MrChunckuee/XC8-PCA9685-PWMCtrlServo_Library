# 1 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c" 2
# 39 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
...
# 39 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c" 2
...
# 40 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c" 2
# 52 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
void I2C_Init(void){
 TRISBbits.RB2 = 1;
 TRISBbits.RB1 = 1;
 SSP2ADD = ((64000000/4000)/100) - 1;
 SSP2STAT = 0b10000000;
 SSP2CON1 = 0b00101000;
}
# 68 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
void I2C_Start(void){
 SSP2CON2bits.SEN = 1;
 while(!PIR3bits.SSP2IF);
 PIR3bits.SSP2IF = 0;
}
# 82 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
void I2C_ReStart(void){
 SSP2CON2bits.RSEN = 1;
 while(!PIR3bits.SSP2IF);
 PIR3bits.SSP2IF = 0;
}
# 96 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
void I2C_Stop(void){
 SSP2CON2bits.PEN = 1;
 while(!PIR3bits.SSP2IF);
 PIR3bits.SSP2IF = 0;
}
# 110 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
void I2C_Send_ACK(void){
...
# 125 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
void I2C_Send_NACK(void){
...
# 140 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
unsigned char I2C_Write_Byte(unsigned char BYTE){
 SSP2BUF = BYTE;
 while(!PIR3bits.SSP2IF);
 PIR3bits.SSP2IF = 0;
...
# 155 "../XC8-18F25K22_ServoCtrl_Module.X/i2c.c"
unsigned char I2C_Read_Byte(void){
 SSP2CON2bits.RCEN = 1;
 while(!PIR3bits.SSP2IF);
 PIR3bits.SSP2IF = 0;
